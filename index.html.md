        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 14px;">
                <div class="team-item" style="padding: 12px; background: #f8fafc; border-radius: 16px;">
                    <strong>Сергей Михайлович</strong> — руководитель. Строгий снаружи, но норм внутри. Доверил мне правки в тестовый контур уже на второй неделе. Говорит: «У тебя глаз намётанный».
                </div>
                <div class="team-item" style="padding: 12px; background: #f8fafc; border-radius: 16px;">
                    <strong>Лёша (бэкенд)</strong> — мой кореш. Вместе ходили в столовку, он научил меня правильно писать запросы и объяснил, почему у них поля называются странно. Без него бы я неделю разбирался с API.
                </div>
                <div class="team-item" style="padding: 12px; background: #f8fafc; border-radius: 16px;">
                    <strong>Настя (QA)</strong> — тестировщик с характером. Находила баги и кидала в чат, но мы потом сдружились. Она научила меня писать понятные баг-репорты и вообще ценить тестирование.
                </div>
                <div class="team-item" style="padding: 12px; background: #f8fafc; border-radius: 16px;">
            ...
            <p style="margin-top: 16px; background: #fef3e2; padding: 12px; border-radius: 14px;">На последней неделе позвали на шашлыки. Я поехал. Коллектив душевный, без офисного снобизма. Практика прошла отлично — узнал кучу реальных вещей, которых в универе не расскажут.</p>
        </div>
    </div>
